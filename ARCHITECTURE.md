...
5. Message Transfer Worker 后续从 Message Outbox 或 Kafka/Redpanda 消费 `message.accepted` 事件，并调度 Gateway/Push 投递。
6. Redis Presence、真实 Gateway fanout、Push worker 和 delivery ACK 由后续链路补齐。
