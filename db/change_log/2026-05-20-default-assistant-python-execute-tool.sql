-- Source of truth for Issue #108 default assistant python.execute tool backfill.
-- Apply with db/migrations/010_default_assistant_python_execute_tool.sql in normal migration order.
