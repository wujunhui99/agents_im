-- Source of truth for Issue #77 default agent_creator assistant data backfill.
-- Apply with db/migrations/009_default_agent_creator_assistant.sql in normal migration order.
