-- Issue #129: make the built-in agent_creator assistant able to create agents.
-- The tool is metadata-only in DB; execution is served by the code whitelisted local handler.
