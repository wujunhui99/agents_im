...
func NewExistsAccountLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ExistsAccountLogic {
...
func (l *ExistsAccountLogic) ExistsAccount(req *types.ExistsReq) (resp *types.ExistsResp, err error) {
