...
func (UnimplementedMediaServer) CreateUploadIntent(context.Context, *CreateUploadIntentRequest) (*CreateUploadIntentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUploadIntent not implemented")
}
...
func (UnimplementedMediaServer) GetAvatarDisplayURL(context.Context, *GetAvatarDisplayURLRequest) (*GetDownloadURLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAvatarDisplayURL not implemented")
}
