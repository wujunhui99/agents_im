...
//     Friends/Messages/AgentAudits/Feedback 仍跨域只读 internal/repository（friendships 无 avatar
//     非 #550 blocker；messages/AI-replay 属 message monolith keystone、agent_audits 无 owning rpc、
//     feedback 由 message monolith 创建），待相关域 rpc 落地后迁移。
