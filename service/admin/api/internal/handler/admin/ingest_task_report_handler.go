...
func IngestTaskReportHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := admin.NewIngestTaskReportLogic(r.Context(), svcCtx)
		resp, err := l.IngestTaskReport(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
