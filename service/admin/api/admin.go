...
import (
	...
	"github.com/wujunhui99/agents_im/service/admin/api/internal/handler"
...
// run starts the admin-api service (纯 BFF): it loads config and serves.
func run(configFile string) {
	...
	if err != nil {
		log.Fatalf("build admin api service context: %v", err)
	}
