...
func (l *KickMemberLogic) KickMember(in *groups.KickMemberRequest) (*groups.MemberResponse, error) {
	result, err := l.svcCtx.GroupsLogic.KickMember(l.ctx, business.KickMemberRequest{GroupID: in.GetGroupId(), OperatorUserID: in.GetOperatorUserId(), UserID: in.GetUserId()})
	if err != nil {
