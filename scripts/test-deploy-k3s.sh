...
if ! grep -Fq "migration_required=true" <<<"${DETECT_OUTPUT}" || \
  ! grep -Fq "backend_services='[\"user-api\",\"auth-api\",\"friends-api\",\"message-api\",\"gateway-ws\",\"groups-api\",\"agent-api\",\"admin-api\",\"message-transfer\",\"user-rpc\",\"auth-rpc\",\"friends-rpc\",\"groups-rpc\",\"message-rpc\",\"third-rpc\",\"media-api\",\"media-rpc\",\"admin-rpc\"]'" <<<"${DETECT_OUTPUT}"; then
