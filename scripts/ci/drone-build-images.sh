...
if [[ "${force_all_images}" == "true" ]]; then
  image_services_space="user-api auth-api friends-api msg-api msggateway groups-api agent-api admin-api msgtransfer push user-rpc auth-rpc friends-rpc groups-rpc msg-rpc third-rpc media-api media-rpc admin-rpc web"
