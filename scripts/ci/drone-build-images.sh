...
if [[ "${force_all_images}" == "true" ]]; then
  image_services_space="user-api auth-api friends-api message-api gateway-ws groups-api agent-api admin-api message-transfer user-rpc auth-rpc friends-rpc groups-rpc message-rpc third-rpc media-api media-rpc web"
