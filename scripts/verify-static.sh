...
required_files=(
  ...
  "service/msg/rpc/msg.go"
  "service/msg/rpc/internal/server/msgserver.go"
  ...
  "service/msg/api/msg.go"
  "service/msg/api/internal/config/config.go"
  "service/msg/api/internal/handler/routes.go"
  "service/msg/api/internal/svc/service_context.go"
  "service/msg/api/internal/types/types.go"
  "service/msg/api/internal/logic/msg/send_message_logic.go"
  "service/msg/api/internal/logic/msg/pull_messages_logic.go"
  "service/msg/api/internal/logic/msg/get_conversation_seqs_logic.go"
  "service/msg/api/internal/logic/msg/mark_conversation_as_read_logic.go"
  "service/msg/api/internal/logic/msg/get_conversation_a_i_hosting_logic.go"
  "service/msg/api/internal/logic/msg/update_conversation_a_i_hosting_logic.go"
  "service/msg/api/internal/logic/msg/create_feedback_logic.go"
  "service/msg/rpc/internal/logic/conversation_ai_hosting_logic.go"
  ...
  "service/msggateway/msggateway.go"
  ...
  "service/auth/rpc/auth.go"
  "service/groups/rpc/groups.go"
  "common/share/gateway/contract.go"
  "service/msgtransfer/internal/transfer/event.go"
  "service/msgtransfer/internal/transfer/interfaces.go"
  "service/msgtransfer/internal/transfer/idempotency.go"
  "service/msgtransfer/internal/transfer/delivery_attempt_recorder.go"
  "service/msgtransfer/internal/transfer/memory.go"
  "service/msgtransfer/internal/transfer/worker.go"
  "service/msgtransfer/internal/transfer/worker_test.go"
  ...
  "service/msggateway/internal/ws/connection_manager.go"
  "service/msggateway/internal/ws/server.go"
  "pkg/messaging/event.go"
  "pkg/messaging/event_test.go"
  "common/share/gateway/delivery/delivery.go"
  "service/msggateway/internal/ws/delivery.go"
  "service/msgtransfer/internal/transfer/gateway/dispatcher.go"
  "service/msgtransfer/internal/transfer/gateway/dispatcher_test.go"
  ...
  "service/msggateway/internal/ws/gateway_ws_test.go"
